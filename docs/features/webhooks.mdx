...
<Frame>
  <img src="/media/ui-webhooks-details.png" alt="Endpoint details panel in the Bifrost Web UI showing recent delivery attempts with their status codes alongside the Test and Rotate secret actions" />
</Frame>
...
| `headers` | object | No | Custom headers sent with every delivery. Values support `env.VAR` syntax and are encrypted at rest. Reserved delivery headers cannot be overridden. |
